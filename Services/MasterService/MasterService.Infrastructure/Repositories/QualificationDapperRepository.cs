...
namespace MasterService.Infrastructure.Repositories
{
    public class QualificationDapperRepository : IQualificationRepository
    {
        ...
        public QualificationDapperRepository(MasterDbContext context, IDbConnection connection)
        {
            _context = context;
        ...
        {
            return await _connection.QueryFirstOrDefaultAsync<Qualification>(
        ...
        {
            return await _connection.QueryAsync<Qualification>(
        ...
        {
            var qualifications = await _connection.QueryAsync<Qualification>(
            ...
            {
                var languages = await _connection.QueryAsync<QualificationLanguage>(
