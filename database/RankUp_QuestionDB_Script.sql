...
ON PRIMARY 
( NAME = N'RankUp_QuestionDB', FILENAME = N'/var/opt/mssql/data/RankUp_QuestionDB.mdf', SIZE = 8192KB, FILEGROWTH = 65536KB )
LOG ON 
( NAME = N'RankUp_QuestionDB_log', FILENAME = N'/var/opt/mssql/data/RankUp_QuestionDB_log.ldf', SIZE = 8192KB, FILEGROWTH = 65536KB )
GO
