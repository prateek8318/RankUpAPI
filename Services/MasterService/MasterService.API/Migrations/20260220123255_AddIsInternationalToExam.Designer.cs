...
namespace MasterService.API.Migrations
{
    ...
    [Migration("20260220123255_AddIsInternationalToExam")]
    partial class AddIsInternationalToExam
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MasterService.Domain.Entities.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MasterService.Domain.Entities.ExamLanguage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ExamId", "LanguageId")
                        .IsUnique();

                    b.ToTable("ExamLanguages");
                });

            modelBuilder.Entity("MasterService.Domain.Entities.ExamQualification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ExamId", "QualificationId", "StreamId")
                        .IsUnique()
                        .HasFilter("[StreamId] IS NOT NULL");
            ...
            modelBuilder.Entity("MasterService.Domain.Entities.ExamLanguage", b =>
                {
                    b.HasOne("MasterService.Domain.Entities.Exam", "Exam")
                        .WithMany("ExamLanguages")
