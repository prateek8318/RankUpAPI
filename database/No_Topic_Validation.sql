-- Completely remove topic validation - make TopicId optional for all modules
...
BEGIN
    ...
    BEGIN TRANSACTION;
    BEGIN TRY
        -- NO TOPIC VALIDATION AT ALL - TopicId is completely optional
        
        -- Just normalize TopicId (treat NULL/0 as NULL)
        ...
        -- Insert question without any topic validation
...
PRINT 'Topic validation completely removed - TopicId is now optional for all modules'
GO
