-- Add Created Questions to Mock Test ID 3 (Fixed Version)
-- =============================================
...
PRINT 'Total questions in Mock Test 3: ' + CAST((SELECT COUNT(*) FROM MockTestQuestions WHERE MockTestId = 3) AS VARCHAR);
PRINT 'Total marks in Mock Test 3: ' + CAST((SELECT SUM(Marks) FROM MockTestQuestions WHERE MockTestId = 3) AS VARCHAR);
