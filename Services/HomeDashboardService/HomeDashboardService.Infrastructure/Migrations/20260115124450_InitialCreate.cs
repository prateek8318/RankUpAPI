        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorReportPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BulkUploadLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaylistId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyVideos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DashboardBanners", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferBanners", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BulkUploadLogs_ProcessedByUserId",
                table: "BulkUploadLogs",
                column: "ProcessedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BulkUploadLogs_Status",
                table: "BulkUploadLogs",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyVideos_IsActive",
                table: "DailyVideos",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_DailyVideos_VideoDate",
                table: "DailyVideos",
                column: "VideoDate");

            migrationBuilder.CreateIndex(
                name: "IX_DashboardBanners_DisplayOrder",
                table: "DashboardBanners",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_DashboardBanners_IsActive",
                table: "DashboardBanners",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_Exams_DisplayOrder",
                table: "Exams",
                column: "DisplayOrder");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaderboardEntries_Rank",
                table: "LeaderboardEntries",
                column: "Rank");
