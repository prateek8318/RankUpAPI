...
-- =====================================================
-- FIX QUESTION DATABASE - ADD MISSING MOCKTEST TABLES
-- =====================================================

-- Drop existing MockTest tables if they exist (to recreate fresh)
IF OBJECT_ID('dbo.MockTestAttempts', 'U') IS NOT NULL DROP TABLE dbo.MockTestAttempts;
IF OBJECT_ID('dbo.MockTestSessionAnswers', 'U') IS NOT NULL DROP TABLE dbo.MockTestSessionAnswers;
IF OBJECT_ID('dbo.MockTestSessions', 'U') IS NOT NULL DROP TABLE dbo.MockTestSessions;
IF OBJECT_ID('dbo.MockTestQuestions', 'U') IS NOT NULL DROP TABLE dbo.MockTestQuestions;
IF OBJECT_ID('dbo.MockTests', 'U') IS NOT NULL DROP TABLE dbo.MockTests;
GO
...
CREATE TABLE [dbo].[MockTests] (
    ...
    [ExamId] INT NOT NULL, -- References RankUp_MasterDB.dbo.Exams
    ...
    [SubscriptionPlanId] INT NULL, -- References RankUp_SubscriptionDB.dbo.SubscriptionPlans
...
CREATE TABLE [dbo].[MockTestSessions] (
    [Id] INT IDENTITY(1,1) PRIMARY KEY,
    [MockTestId] INT NOT NULL,
    [UserId] INT NOT NULL, -- References RankUp_UserDB.dbo.Users
...
-- Insert sample mock tests (assuming ExamId 1 exists in MasterDB)
...
('Railway Group D Mock Test 01', 
 ...
 1, -- ExamId 1 should exist in RankUp_MasterDB.dbo.Exams
 30, -- 30 minutes
 20, -- 20 questions
...
PRINT 'MockTest tables created successfully in RankUp_QuestionDB!';
GO

-- =====================================================
-- VIEWS FOR CROSS-DATABASE REFERENCES
-- =====================================================

-- Create view for MockTests with Exam details (cross-database reference)
IF OBJECT_ID('dbo.vw_MockTestsWithExamDetails', 'V') IS NOT NULL DROP VIEW dbo.vw_MockTestsWithExamDetails;
GO
CREATE VIEW dbo.vw_MockTestsWithExamDetails AS
SELECT 
...
-- Create view for Questions with Exam and Subject details (cross-database reference)
IF OBJECT_ID('dbo.vw_QuestionsWithDetails', 'V') IS NOT NULL DROP VIEW dbo.vw_QuestionsWithDetails;
GO
CREATE VIEW dbo.vw_QuestionsWithDetails AS
SELECT 
    ...
    q.CreatedBy, q.ReviewedBy, q.IsPublished, q.PublishDate, q.CreatedAt, q.UpdatedAt, q.IsActive
FROM [dbo].[Questions] q;
GO

PRINT 'Views created for cross-database references!';
GO
