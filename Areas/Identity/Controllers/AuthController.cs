...
using RankUpAPI.Areas.Identity.Models;
using RankUpAPI.Services;
using Microsoft.Extensions.Logging;
using RankUpAPI.Data;

namespace RankUpAPI.Areas.Identity.Controllers
{
    [ApiController]
    [Area("Identity")]
...
public async Task<IActionResult> VerifyOtp([FromBody] OtpVerificationRequest request)
{
    try
    {
        ...
        // Check OTP
        if (!OtpStore.TryGetValue(otpKey, out var storedOtp) || storedOtp != request.Otp)
        {
        ...
        // Update last login and mark phone verified inside a transaction
        try
        {
        ...
        // Generate token (include user id as NameIdentifier claim)
