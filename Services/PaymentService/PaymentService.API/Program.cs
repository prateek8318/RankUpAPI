...
{
    var connectionString = builder.Configuration.GetConnectionString("PaymentServiceConnection");
    options.UseSqlServer(connectionString, sqlServerOptions =>
    {
        ...
        sqlServerOptions.MigrationsAssembly(typeof(PaymentDbContext).Assembly.GetName().Name);
    });
});
