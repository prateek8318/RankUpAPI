-- Create UserSubscription_Create Stored Procedure
-- This procedure creates a new user subscription with all required parameters
...
PRINT 'UserSubscription_Create stored procedure created successfully';
