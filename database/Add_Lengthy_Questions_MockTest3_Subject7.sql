-- Add Lengthy Questions for Mock Test ID 3 with Subject ID 7
-- =============================================

-- First, let's create lengthy questions with proper translations
...
VALUES (
    1, -- ModuleId (will need to verify)
    (SELECT TOP 1 Id FROM Exams WHERE SubjectId = 7), -- ExamId for Subject 7
    7, -- SubjectId
    NULL, -- TopicId (will set later)
