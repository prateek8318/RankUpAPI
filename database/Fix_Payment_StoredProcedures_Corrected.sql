...
BEGIN
    ...
    SET 
        ...
        [RazorpayOrderId] = ISNULL(@RazorpayOrderId, [RazorpayOrderId]),
        [RazorpayPaymentId] = ISNULL(@RazorpayPaymentId, [RazorpayPaymentId]),
        [RazorpaySignature] = ISNULL(@RazorpaySignature, [RazorpaySignature]),
        ...
        [RazorpayRefundId] = ISNULL(@RazorpayRefundId, [RazorpayRefundId]),
...
-- Create Payment_GetByTransactionId stored procedure (using RazorpayPaymentId)
...
-- Create Payment_GetByProviderOrderId stored procedure (using RazorpayOrderId)
